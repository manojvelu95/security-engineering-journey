...
Doctors can access patient records only while on duty.
...
Invoice #123 belongs to Manoj.

The server should verify ownership before returning the invoice.

Ownership validation is critical to prevent Broken Access Control vulnerabilities.
...
<img width="233" height="342" alt="authorization_flow" src="https://github.com/user-attachments/assets/9d3658e4-970a-4655-ba22-e63e732d59f7" />
<img width="190" height="358" alt="authorization_securityperspective" src="https://github.com/user-attachments/assets/73f6c014-89a0-46bb-91e3-0a6ae8857803" />
